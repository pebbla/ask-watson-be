...
public class ThemeController {
    ...
    public SingleResponse<Theme> createTheme(@PathVariable Long cafeId, @RequestPart ThemeParams params, @RequestPart(value = "file", required = false) MultipartFile file) throws Exception {
    ...
    public SingleResponse<ThemeDto.Response> modifyTheme(@PathVariable Long themeId, @RequestPart ThemeParams params, @RequestPart(value = "file", required=false) MultipartFile file) throws Exception {
