...
INSERT INTO cafe(cafe_name,cafe_phone_num,location_id,company_id,geography,website,address) VALUES ('포인트나인 강남점','02-1919-1919',1, 1, POINT(127.127730, 38.439801),"http://www.pointnine.com","서울시 서초구 서초3동 어쩌구 주소");
INSERT INTO cafe(cafe_name,cafe_phone_num,location_id,company_id,geography,website,address) VALUES ('더클루 강남점','02-2323-1111',1, 2, POINT(127.127730, 38.439801),"http://www.theclue.com","서울시 어쩌구 주소");
INSERT INTO cafe(cafe_name,cafe_phone_num,location_id,company_id,geography,website,address) VALUES ('룰루랄라라','02-6653-1624',5, 4, POINT(127.127730, 38.439801),"http://www.lululalala.com","어쩌구 주소");
INSERT INTO cafe(cafe_name,cafe_phone_num,location_id,company_id,geography,website,address) VALUES ('방탈출고고싱','031-2020-1124',12, 4, POINT(127.127730, 38.439801),"http://www.gogosing.com","주소주소입니다주소");

INSERT INTO theme(theme_name,theme_explanation,category_id,difficulty,time_limit,cafe_id,min_num_people,price,reservation_url) VALUES('포인트나인나인','포인트 아홉개를 연결함으로써 별자리를 완성해보세요!',3,3.5,60,1,2,24000,"http://www.pointnine-reservation.com");
INSERT INTO theme(theme_name,theme_explanation,category_id,difficulty,time_limit,cafe_id,min_num_people,price,reservation_url) VALUES('포인트에잇','포인트 여덟개를 연결해서 별자리를 완성해봅시다',1,4.0,70,1,1,22000,"http://www.pointeight-reservation.com");
INSERT INTO theme(theme_name,theme_explanation,category_id,difficulty,time_limit,cafe_id,min_num_people,price,reservation_url) VALUES('포인트세븐','럭키세븐',3,2.0,50,1,4,18000,"https://www.pointseven-reservation.co.kr");
INSERT INTO theme(theme_name,theme_explanation,category_id,difficulty,time_limit,cafe_id,min_num_people,price,reservation_url) VALUES('더클루1','더클루테마1입니당',6,3.5,60,2,2,24000,"http://www.theclue1-reservation.ac.kr");
INSERT INTO theme(theme_name,theme_explanation,category_id,difficulty,time_limit,cafe_id,min_num_people,price,reservation_url) VALUES('더클루2','더클루테마2입니당',1,4.3,70,2,1,21000,"http://www.theclue2-reservation.ac.kr");
INSERT INTO theme(theme_name,theme_explanation,category_id,difficulty,time_limit,cafe_id,min_num_people,price,reservation_url) VALUES('더클루3','더클루테마3입니당',1,4.2,70,2,1,30000,"http://www.theclue3-reservation.ac.kr");
INSERT INTO theme(theme_name,theme_explanation,category_id,difficulty,time_limit,cafe_id,min_num_people,price,reservation_url) VALUES('더클루4','더클루테마4입니당',1,4.7,70,2,1,40000,"http://www.theclue4-reservation.ac.kr");
